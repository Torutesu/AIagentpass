...
function publicReadinessChecks(value) {
  ...
  if (ownerRecoveryOutbox !== undefined && (!ownerRecoveryOutbox || typeof ownerRecoveryOutbox.ok !== "boolean" || typeof ownerRecoveryOutbox.code !== "string"
    ...
    || !integerOrNull(ownerRecoveryOutbox.pending_count) || !integerOrNull(ownerRecoveryOutbox.uncertain_count) || !integerOrNull(ownerRecoveryOutbox.dead_letter_count) || !integerOrNull(ownerRecoveryOutbox.oldest_pending_age_ms))) throw new Error("invalid readiness checks");
