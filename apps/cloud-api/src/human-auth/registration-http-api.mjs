...
const ERROR_STATUS = Object.freeze({
  ...
  [WEBAUTHN_REGISTRATION_HTTP_ERROR_CODES.RECENT_AUTH_REQUIRED]: 428,
...
function mapServiceError(error, phase) {
  ...
  if (error instanceof WebAuthnRegistrationError || error?.name === "WebAuthnRegistrationError") {
    ...
    if (error.code === WEBAUTHN_REGISTRATION_ERROR_CODES.RECENT_AUTH_REQUIRED) return new WebAuthnRegistrationHttpError(WEBAUTHN_REGISTRATION_HTTP_ERROR_CODES.RECENT_AUTH_REQUIRED, { status: 428, cause: error });
