...
const TABLES = [
  ...
  "devices", "device_enrollments", "release_candidates", "device_enrollment_possession_receipts", "agents", "policies", "revocations", "capabilities", "bundle_heads", "bundle_acknowledgements",
