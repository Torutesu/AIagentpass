...
const TABLES = [
  ...
  "device_audit_gaps", "idempotency_records", "device_request_nonces", "rate_limit_buckets", "anonymous_rate_limit_buckets", "human_identity_assertion_replays", "owner_recovery_requests", "owner_recovery_approvals", "owner_recovery_exchanges", "owner_recovery_sessions", "owner_recovery_outbox", "owner_recovery_webauthn_challenges", "owner_recovery_idempotency_records", "control_plane_authority_generations", "device_key_epochs", "device_control_plane_state", "control_bundle_statements", "device_refresh_outbox", "device_refresh_delivery_attempts", "device_bundle_acknowledgements", "device_manual_wake_events", "device_manual_wake_requests", "schema_migration_attempts"
];
