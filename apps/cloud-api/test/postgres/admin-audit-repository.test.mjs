...
class AuditClient {
  constructor() { this.calls = []; this.requestHash = null; this.storedResponse = null; this.event = null; }
  async query(text, params = []) {
    ...
    if (text.startsWith("SELECT id,organization_id,actor_id")) return result([{
      ...
      target_type: "policy", target_id: targetId, event_hash: this.storedResponse.event_hash,
      event_json: this.event, created_at: now
    }]);
