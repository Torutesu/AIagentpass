...
const LIVE_BROWSER_SAFE_FAILURE_MARKERS = Object.freeze([
  ...
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_SESSION_ID_FORMAT_FAILED", "owner_open_session_contract_session_id_format"],
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_MEMBER_ID_FORMAT_FAILED", "owner_open_session_contract_member_id_format"],
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_ORGANIZATION_ID_FORMAT_FAILED", "owner_open_session_contract_organization_id_format"],
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_ROLE_VALUE_FAILED", "owner_open_session_contract_role_value"],
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_TIMESTAMP_FORMAT_FAILED", "owner_open_session_contract_timestamp_format"],
  [null, "P0B_SAFE_OWNER_OPEN_SESSION_RESPONSE_CONTRACT_CSRF_FORMAT_FAILED", "owner_open_session_contract_csrf_format"],
