...
const LIVE_BROWSER_SAFE_FAILURE_MARKERS = Object.freeze([
  ...
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_FETCH_FAILED", "stale_auth_verify_fetch"],
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_HTTP_401_FAILED", "stale_auth_verify_http_401"],
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_HTTP_4XX_FAILED", "stale_auth_verify_http_4xx"],
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_HTTP_5XX_FAILED", "stale_auth_verify_http_5xx"],
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_HTTP_OTHER_FAILED", "stale_auth_verify_http_other"],
  [null, "P0B_SAFE_STALE_AUTH_VERIFY_FULFILL_FAILED", "stale_auth_verify_fulfill"],
  ...
  [null, "P0B_SAFE_STALE_AUTH_RESPONSE_HTTP_2XX_FAILED", "stale_auth_response_http_2xx"],
  [null, "P0B_SAFE_STALE_AUTH_RESPONSE_HTTP_3XX_FAILED", "stale_auth_response_http_3xx"],
  [null, "P0B_SAFE_STALE_AUTH_RESPONSE_HTTP_4XX_FAILED", "stale_auth_response_http_4xx"],
  [null, "P0B_SAFE_STALE_AUTH_RESPONSE_HTTP_5XX_FAILED", "stale_auth_response_http_5xx"],
  [null, "P0B_SAFE_STALE_AUTH_RESPONSE_HTTP_OTHER_FAILED", "stale_auth_response_http_other"],
  [null, "P0B_SAFE_STALE_AUTH_ALERT_MISSING_FAILED", "stale_auth_alert_missing"],
