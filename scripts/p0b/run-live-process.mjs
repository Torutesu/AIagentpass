...
const LIVE_BROWSER_SAFE_FAILURE_MARKERS = Object.freeze([
  ...
  [null, "P0B_SAFE_SCENARIO_ERROR_ASSERTION_FAILED", "scenario_error_assertion"],
  ...
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_CLOUD_UNAVAILABLE_FAILED", "owner_open_summary_cloud_unavailable"],
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_CLOUD_TIMEOUT_FAILED", "owner_open_summary_cloud_timeout"],
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_CLOUD_ERROR_FAILED", "owner_open_summary_cloud_error"],
  ...
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_BODY_INVALID_FAILED", "owner_open_summary_body_invalid"],
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_BODY_SHAPE_FAILED", "owner_open_summary_body_shape"],
  [null, "P0B_SAFE_OWNER_OPEN_SUMMARY_BODY_SHAPE_OK_FAILED", "owner_open_summary_body_shape_ok"],
  ...
  [null, "P0B_SAFE_ADMIN_OPEN_SUMMARY_HTTP_5XX_FAILED", "admin_open_summary_http_5xx"],
  [null, "P0B_SAFE_ADMIN_OPEN_SUMMARY_CLOUD_INVALID_RESPONSE_FAILED", "admin_open_summary_cloud_invalid_response"],
  [null, "P0B_SAFE_ADMIN_OPEN_SUMMARY_CLOUD_UNAVAILABLE_FAILED", "admin_open_summary_cloud_unavailable"],
  [null, "P0B_SAFE_ADMIN_OPEN_SUMMARY_RESPONSE_CONTRACT_FAILED", "admin_open_summary_response_contract"],
  [null, "P0B_SAFE_AUDITOR_OPEN_SUMMARY_NO_RESPONSE_FAILED", "auditor_open_summary_no_response"],
  [null, "P0B_SAFE_AUDITOR_OPEN_SUMMARY_HTTP_FAILED", "auditor_open_summary_http_failed"],
  [null, "P0B_SAFE_AUDITOR_OPEN_SUMMARY_CLOUD_INVALID_RESPONSE_FAILED", "auditor_open_summary_cloud_invalid_response"],
  [null, "P0B_SAFE_AUDITOR_OPEN_SUMMARY_RESPONSE_CONTRACT_FAILED", "auditor_open_summary_response_contract"],
  [null, "P0B_SAFE_ADMIN_FINAL_OPEN_FAILED", "admin_final_open"],
  [null, "P0B_SAFE_ADMIN_FINAL_SETUP_FAILED", "admin_final_setup"],
  [null, "P0B_SAFE_ADMIN_FINAL_STOP_FAILED", "admin_final_stop"],
  [null, "P0B_SAFE_ADMIN_FINAL_CONFIRM_FAILED", "admin_final_confirm"],
  [null, "P0B_SAFE_OWNER_FINAL_SETUP_FAILED", "owner_final_setup"],
  [null, "P0B_SAFE_OWNER_FINAL_STOP_FAILED", "owner_final_stop"],
  [null, "P0B_SAFE_OWNER_FINAL_CONFIRM_FAILED", "owner_final_confirm"],
  [null, "P0B_SAFE_ADMIN_FINAL_STOP_STILL_ACTIVE_FAILED", "admin_final_stop_still_active"],
  [null, "P0B_SAFE_ADMIN_FINAL_STATE_NOT_VISIBLE_FAILED", "admin_final_state_not_visible"],
  [null, "P0B_SAFE_OWNER_FINAL_STOP_STILL_ACTIVE_FAILED", "owner_final_stop_still_active"],
  ...
  [null, "P0B_SAFE_LIFECYCLE_STARTUP_TIMEOUT_FAILED", "lifecycle_startup_timeout"],
  [null, "P0B_SAFE_SCENARIO_RUNTIME_TIMEOUT_FAILED", "scenario_runtime_timeout"],
...
function emitCommandDiagnostic(stage, result) {
  ...
  for (const diagnostic of Array.isArray(result?.internal?.diagnostics) ? result.internal.diagnostics.slice(0, 24) : []) {
    if (typeof diagnostic === "string" && /^P0B_DIAGNOSTIC_[A-Z_]+ [A-Za-z0-9_=,.:\[\]-]{1,1024}$/u.test(diagnostic)) {
