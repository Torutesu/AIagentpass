...
CREATE TABLE human_identity_assertion_replays (
...
CREATE INDEX human_identity_assertion_replays_expiry
  ON human_identity_assertion_replays (expires_at, jti_digest);
...
CREATE FUNCTION agentpass_consume_human_identity_assertion(
...
BEGIN
  ...
  INSERT INTO human_identity_assertion_replays (jti_digest, expires_at)
