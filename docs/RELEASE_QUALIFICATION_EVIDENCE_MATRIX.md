...
| External qualification aggregate provenance | Canonical aggregate evidence/binding, detached Ed25519 signature, public key, pinned fingerprint, and verification result | `node /opt/agentpass/release/qualification-tool/verify-external-qualification-signature.mjs EVIDENCE BINDING SIGNATURE PUBLIC-KEY 'SHA256:PINNED'` | `not_proven` |
| External qualification child provenance | Canonical child evidence plus aggregate evidence/binding, detached Ed25519 signature, public key, pinned fingerprint, and verification result | `node /opt/agentpass/release/qualification-tool/verify-external-qualification-signature.mjs EVIDENCE BINDING SIGNATURE PUBLIC-KEY 'SHA256:PINNED' CHILD-EVIDENCE` | `not_proven` |
