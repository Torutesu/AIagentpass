...
const childMachService = "dev.agentpass.child-git";
...
if (config.child_mach_service_name !== childMachService) throw new Error("Child Mach service example is missing or invalid");
