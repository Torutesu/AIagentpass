...
async function waitForHttps(origin, ca, { path: requestPath, headers = {}, expectedStatus = 200, timeoutMs = 20_000, process: child, label = "service" } = {}) {
  ...
  const readinessMarker = unknownCheckKey !== undefined
    ...
    : readinessDiagnostic === "status_503_agent_session_signing_capability_maintenance_worker_unavailable"
      ? "P0B_SAFE_LIFECYCLE_CLOUD_CAPABILITY_MAINTENANCE_WORKER_FAILED"
    : readinessDiagnostic === "status_503_health_readiness_checks_disagree"
      ? "P0B_SAFE_LIFECYCLE_CLOUD_HEALTH_READINESS_DISAGREE_FAILED"
