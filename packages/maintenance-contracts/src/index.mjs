...
export function validateMaintenancePlan(v) { return validateSimple(v, 'agentpass.maintenance.plan', new Set(['schema_version','kind','plan_id','organization_id','app_id','repository_id','branch','advisory_id','selector_digests','files','authority']), ['schema_version','kind','plan_id','organization_id','app_id','repository_id','branch','advisory_id','selector_digests','files','authority']); }
...
export function validateMaintenanceReceipt(v) { const x = validateSimple(v, 'agentpass.maintenance.receipt', new Set(['schema_version','kind','receipt_id','organization_id','job_id','source_commit','patch_digest','verification_status','created_at','uncertainty']), ['schema_version','kind','receipt_id','organization_id','job_id','source_commit','patch_digest','verification_status','created_at','uncertainty']); timestamp(x.created_at, 'created_at'); return x; }
